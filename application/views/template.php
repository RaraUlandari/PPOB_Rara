      ...
      <header class="header black-bg">
            ...
            <div class="top-menu">
            	<ul class="nav pull-right top-menu">
                    <li><a class="logout" href="<?=base_url()?>index.php/Login/logout">Logout</a></li>
            	</ul>
            </div>
        </header>
      <!--header end-->
                ...
                <?php
                    if($this->session->userdata('nama_level')=='Manager') {
                        ...
                        ?>
                            ...
                            <li><a href="#"><i class="lnr lnr-home"></i><span>Level</span></a></li>
                            <li><a href="#"><i class="lnr lnr-list"></i><span>Pelanggan</span></a></li>
                            <li><a href="#"><i class="lnr lnr-home"></i><span>Admin</span></a></li>
